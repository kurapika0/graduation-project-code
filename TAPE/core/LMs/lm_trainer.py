...
class LMTrainer():
    def __init__(self, cfg):
        ...
        pretrained_model_path = '/data/fusike/TAPE/my_model/'
        tokenizer = AutoTokenizer.from_pretrained(pretrained_model_path + self.model_name +'/tokenizer')
        ...
        bert_model = AutoModel.from_pretrained(pretrained_model_path + self.model_name + '/model')
